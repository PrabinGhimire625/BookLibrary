...
const SingleBook = () => {
  //useParams is the hook used when <Route path="/book/:id" element={<SingleBook/>}/>
  const {id}=useParams();
  ...
  //fetchBook() invoked hunu paro jaba kunai manxa le yo page request garxa
  useEffect(()=>{
    fetchBook()
  },[])

  //print and check usestate bhitra obj ma data ayo ki ayana vanara
  console.log(book);
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">{book.bookName}</h1>
        <div class="flex mb-4">
        ...
        <div class="flex">
          <span class="title-font font-medium text-2xl text-gray-900">Rs.{book.bookPrice}</span>
