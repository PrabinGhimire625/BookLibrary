...
import { getLatestHistoricalBooks } from '../../store/ReviewSlice';
import { Link } from 'react-router-dom';

const HistoricalBook = () => {
  const dispatch = useDispatch();
  const { latestHistoricalBooks } = useSelector((state) => state.review);

  useEffect(() => {
    dispatch(getLatestHistoricalBooks());
  }, [dispatch]);
