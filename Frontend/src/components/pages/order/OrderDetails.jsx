        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="bg-white shadow rounded-lg p-6 w-full lg:w-80 space-y-6">
            <div>
              ...
              {singleOrder?.status === 'Pending' && (
                <button
                  ...
                  className={`w-full text-center py-2 border rounded-lg text-red-600 hover:bg-red-100 transition ${loading ? 'opacity-50 cursor-not-allowed' : ''
                    }`}
                  disabled={loading}
                >
            ...
            <div>
              ...
              <button className="w-full text-center py-2 border rounded-lg hover:bg-gray-100 transition">
                Download Invoice
              </button>
            </div>
          </div>
